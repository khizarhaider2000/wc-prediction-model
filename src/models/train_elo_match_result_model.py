"""Train and compare Elo/FIFA Logistic Regression match result baselines."""
...
DATA_PATH = PROJECT_ROOT / "data" / "processed" / "elo_match_training_dataset.csv"
MODEL_OUTPUT_PATH = (
    PROJECT_ROOT / "models" / "match_result_logistic_regression_elo.pkl"
)
...
def train_and_evaluate(
    ...
    print("\n" + "=" * 72)
    print(
        "Elo/FIFA Logistic Regression baseline "
...
def main() -> None:
    ...
    if best_result["label"] == "balanced":
        print("\nSaved balanced Elo/FIFA Logistic Regression baseline")
    else:
        print("\nSaved unbalanced Elo/FIFA Logistic Regression baseline")
